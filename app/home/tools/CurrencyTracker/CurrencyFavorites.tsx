...
export default function CurrencyFavorites({
  ...
  const calculateRate = (base: CurrencyCode, target: CurrencyCode): number | null => {
      ...
      {isLoading ? (
        ...
        <div className="flex items-center justify-center py-3 text-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-400">No favorite pairs added yet</span>
          </div>
        </div>
      ) : (
        <div
        ...
        >
          <div className="flex gap-2 pb-1" style={{ paddingRight: '1px' }}>
            {favorites.map(favorite => {
              const rate = calculateRate(favorite.baseCurrency, favorite.targetCurrency)
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-1 text-xs text-gray-400">
                    ...
                    <span className="font-medium text-white">{rate ? rate.toFixed(4) : '―'}</span>
                  </div>
                </div>
              )
            })}
