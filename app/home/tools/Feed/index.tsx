...
const Feed = () => {
  ...
  return (
    <div className="p-2 overflow-hidden bg-black bg-opacity-30 backdrop-blur-3xl h-full max-w-full rounded-xl w-full shadow-xl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-center pl-4">Feed</h1>
        <Nav
          tabs={["rss", "reddit", "hackernews"]} // , "twitter", "youtube", "github" - later
          tab={source}
          setTab={setSource}
          className="p-0 py-0"
        />
