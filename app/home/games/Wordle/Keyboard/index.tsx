            ...
            <m.button
              ...
              animate={{
                ...
                backgroundColor:
                  key === 'enter'
                    ...
                    : key === '<-'
                      ...
                      : board
                            .flat()
                            .some(letter => letter.letter === key && letter.status === 'correct')
                        ? '#ff0000'
                        : board
                              .flat()
                              .some(
                                letter => letter.letter === key && letter.status === 'misplaced'
                              )
                          ? '#eab308'
                          : board
                                .flat()
                ...
                color:
                  key === 'enter' ||
                  key === '<-' ||
                  board.flat().some(letter => letter.letter === key && !(letter.status === 'empty'))
                    ? '#fff'
                    : '#000',
              }}
              whileTap={{ y: 2 }}
              ...
              onClick={() => {
                key === 'enter' ? submitWord() : key === '<-' ? removeKey() : addKey(key)
              }}
            >
              {key}
            </m.button>
