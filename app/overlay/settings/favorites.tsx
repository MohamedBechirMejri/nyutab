...
import { AlertCircle, ExternalLink, Globe, Plus, Trash2 } from 'lucide-react'
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="font-medium truncate">{getDomainFromUrl(fav)}</p>
                        <p className="text-xs truncate text-muted-foreground">{fav}</p>
                      </div>
