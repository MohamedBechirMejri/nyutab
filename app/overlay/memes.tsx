        ...
        <div className="w-full h-full flex flex-wrap gap-2 overflow-y-auto p-4">
          {filtered.length ? (
            filtered.map((meme, i: number) => {
              return (
                <div
                  ...
                  className={
                    'w-[19%] h-[calc(80vh/5)] rounded-lg border-zinc-500 border shadow hover:ring-4 hover:ring-orange-500 transition-all duration-300'
                  }
                  style={{
            ...
            <div className="flex items-center justify-center w-full h-full">
              <h1 className="text-2xl font-bold text-gray-500">No memes found</h1>
            </div>
          )}
        </div>
      </div>
        ...
        <div className="h-full w-full rounded-lg overflow-hidden flex flex-col items-center">
          {preview ? (
            ...
            <div className="flex items-center justify-center h-full bg-white w-full">
              <h1 className="text-2xl font-bold text-gray-500">Click on a meme to preview</h1>
            </div>
          )}
        </div>
