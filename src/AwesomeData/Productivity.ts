const AwesomeProductivityData = [
  {
    ...
    links: [
      {
        title: "12+ Tips and Tricks to Work Faster in Microsoft Outlook",
        url: "http://lifehacker.com/12-tips-and-tricks-to-work-faster-in-microsoft-outlook-1540483009",
        description:
          "Tame your Outlook with these tips in order to get a little bit closer to the awesome _Inbox Zero_.",
      },
      {
        title: "Advanced GTD with Remember The Milk",
        url: "http://blog.rememberthemilk.com/post/116665489183/guest-post-advanced-gtd-with-remember-the-milk",
        description:
          "A tutorial on how to implement GTD with Remember the Milk.",
      },
      {
        title: "Inbox Zero",
        url: "http://www.43folders.com/izero",
        description:
...
// - [Todo.txt](http://todotxt.com/) - Tired of having complicated apps to organize your tasks? Todo.txt is a technique that uses a single
